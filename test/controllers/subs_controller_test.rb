...
class SubsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub" do
    assert_difference('Sub.count') do
      post subs_url, params: { sub: { amount: @sub.amount, description: @sub.description, frequency: @sub.frequency, frequency: @sub.frequency, name: @sub.name } }
    end
  ...
  test "should update sub" do
    patch sub_url(@sub), params: { sub: { amount: @sub.amount, description: @sub.description, frequency: @sub.frequency, frequency: @sub.frequency, name: @sub.name } }
